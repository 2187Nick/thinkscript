...
def putOptionopen_interest13 = if IsNaN(open_interest("." + GetSymbol() + AsPrice(DateString) + "P"+ AsPrice(PutStrike - strikeSpacing * 12), agg)) then 0 else open_interest("." + GetSymbol() + AsPrice(DateString) + "P"+ AsPrice(PutStrike - strikeSpacing * 12), agg);
def putOptionopen_interest12 = if IsNaN(open_interest("." + GetSymbol() + AsPrice(DateString) + "P"+ AsPrice(PutStrike - strikeSpacing * 13), agg)) then 0 else open_interest("." + GetSymbol() + AsPrice(DateString) + "P"+ AsPrice(PutStrike - strikeSpacing * 13), agg);
...
def putOptionopen_interest13a = if IsNaN(open_interest("." + GetSymbol() + AsPrice(DateString) + "P"+ AsPrice(PutStrike + strikeSpacing * 12), agg)) then 0 else open_interest("." + GetSymbol() + AsPrice(DateString) + "P"+ AsPrice(PutStrike + strikeSpacing * 12), agg);
def putOptionopen_interest12a = if IsNaN(open_interest("." + GetSymbol() + AsPrice(DateString) + "P"+ AsPrice(PutStrike + strikeSpacing * 13), agg)) then 0 else open_interest("." + GetSymbol() + AsPrice(DateString) + "P"+ AsPrice(PutStrike + strikeSpacing * 13), agg);
...
def callOptionopen_interest13a = if IsNaN(open_interest("." + GetSymbol() + AsPrice(DateString) + "C"+ AsPrice(CallStrike - strikeSpacing * 12), agg)) then 0 else open_interest("." + GetSymbol() + AsPrice(DateString) + "C"+ AsPrice(CallStrike - strikeSpacing * 12), agg);
def callOptionopen_interest12a = if IsNaN(open_interest("." + GetSymbol() + AsPrice(DateString) + "C"+ AsPrice(CallStrike - strikeSpacing * 13), agg)) then 0 else open_interest("." + GetSymbol() + AsPrice(DateString) + "C"+ AsPrice(CallStrike - strikeSpacing * 13), agg);
