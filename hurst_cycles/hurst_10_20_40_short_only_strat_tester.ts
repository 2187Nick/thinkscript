# FLD Cross 10, 20, 40 Day Cycles Strategy Tester Short Only
# @2187Nick
...
#addOrder(OrderType.BUY_TO_OPEN, didwecrossup, tickColor = GetColor(6), arrowColor = GetColor(6));
#addOrder(OrderType.SELL_TO_CLOSE, close >= crossupTarget1 or close < DailySMA2, tickColor = GetColor(5), arrowColor = GetColor(5));

#addOrder(OrderType.BUY_TO_OPEN, didwecrossup, close, 1, Color.green, color.green,  "Buy To Open");
#addOrder(OrderType.SELL_TO_CLOSE, close >= crossupTarget1 or close < DailySMA2, close, 1, Color.green, color.green,  "Sell To Close");
